...
trained_model_name = f"judith_llama3.2_3b2596_steps"
...
training_args = TrainingArguments(
    ...
    logging_dir=f'{trained_model_name}/logs_eval',
    logging_steps=1,
    optim="adamw_torch",
...
model_flops = (
    finetuned_model.floating_point_ops(
        {
...
print("Memory footprint", finetuned_model.get_memory_footprint() / 1e9, "GB")
...
final_results = f"Evaluation metrics {eval_metrics}"
